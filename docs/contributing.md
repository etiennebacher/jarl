...
Contributors are allowed to submit code generated by AI in their PRs, as long as they have reviewed it.
Some special attention should be given to documentation and code comments, where AI tools tend to be incorrect or overly verbose.
