...
pub(crate) async fn handle_initialized(lsp_state: &LspState) -> anyhow::Result<()> {
        ...
        .dynamic_registration_for_did_change_watched_files
    {
        ...
        let watch_flir2_toml_registration = lsp_types::Registration {
            id: String::from("flir2-toml-watcher"),
            method: "workspace/didChangeWatchedFiles".into(),
            register_options: Some(
                serde_json::to_value(DidChangeWatchedFilesRegistrationOptions {
                    watchers: vec![
                        FileSystemWatcher {
                            glob_pattern: lsp_types::GlobPattern::String("**/flir2.toml".into()),
                            kind: None,
                        },
                        FileSystemWatcher {
                            glob_pattern: lsp_types::GlobPattern::String("**/.flir2.toml".into()),
        ...
        registrations.push(watch_flir2_toml_registration);
    }
