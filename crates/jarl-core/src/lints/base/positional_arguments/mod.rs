...
mod tests {
    ...
    fn test_positional_arguments_max_positional_args() {
        ...
        let settings =
            settings_with_options(PositionalArgumentsOptions { max_positional_args: Some(3) });
        assert_snapshot!(
        ...
        let settings =
            settings_with_options(PositionalArgumentsOptions { max_positional_args: Some(0) });
        assert_snapshot!(
